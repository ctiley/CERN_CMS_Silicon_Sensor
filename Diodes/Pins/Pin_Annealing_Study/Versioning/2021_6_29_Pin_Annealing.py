...
guess_40C = np.array([ 2.44246995e+00,  1.30075025e-04,  2.32761517e+01, -1.47378007e+00, 1.08081188e-01,  1.58951967e-01,  4.29526821e-02])
...
guess_100C = np.array([0.83571204, 0.11605724, 3.69755512, 0.26, 0.27488263, 0.00604416, 3.32245495])
...
# Curve Fitting Using 100C Annealing Parameters Using Data
...
# Curve Fitting Using 100C Annealing Parameters with Raw Data from Above Without Time Shift
...
params_100C, params_covariance_100C = curve_fit(exponential_2, Annealing_100C_Shifted_and_Scaled_data['Annealing Time (Min)'], Annealing_100C_Shifted_and_Scaled_data['Pin106 Vf (10 min R irad)'])
...
params_90C, params_covariance_90C = curve_fit(exponential_2, fitted_annealing_90C, fitted_exponential_90C_raw)
fitted_exponential_90C = param_1*np.exp(-param_2*(params_90C[0]*(fitted_annealing_90C) + param_3)) + param_4 + param_5*np.exp(-param_6*(params_90C[0]*(fitted_annealing_90C )-param_7))  + params_90C[1]        

params_100C, params_covariance_100C = curve_fit(exponential_2, fitted_annealing_100C, fitted_exponential_100C_raw)
fitted_exponential_100C = param_1*np.exp(-param_2*(params_100C[0]*(fitted_annealing_100C ) + param_3)) + param_4 + param_5*np.exp(-param_6*(params_100C[0]*(fitted_annealing_100C )-param_7))  + params_100C[1]
